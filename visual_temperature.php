<?php
  ...
  $temperature_2 = mysqli_query($connection,"SELECT temperature FROM datatraining");
  while ($result = mysqli_fetch_array($temperature_2)) {
...
<head>
  ...
  <title>Visualization - Temperature</title>
            ...
            <div class="col-md-12"> 
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <table border="1">
                    <tr>
                      <th>0</th><td>:</td><td>Not Occupied</td>
                    </tr>
                    <tr>
                      <th>1</th><td>:</td><td>Occupied</td>
                    </tr>
                  </table>
                </div>
              </div>
